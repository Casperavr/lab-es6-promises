...
async function makeBroccoli(){
  try{
    ...
    broccoliElement.innerHTML += `<li>${step0}</li>`;
    const step1 = await obtainInstruction("broccoli", 1);
    broccoliElement.innerHTML += `<li>${step1}</li>`;
    const step2 = await obtainInstruction("broccoli", 2);
    broccoliElement.innerHTML += `<li>${step2}</li>`;
    const step3 = await obtainInstruction("broccoli", 3);
    broccoliElement.innerHTML += `<li>${step3}</li>`;
    const step4 = await obtainInstruction("broccoli", 4);
    broccoliElement.innerHTML += `<li>${step4}</li>`;
    const step5 = await obtainInstruction("broccoli", 5);
    broccoliElement.innerHTML += `<li>${step5}</li>`;
    const step6 = await obtainInstruction("broccoli", 6);
    broccoliElement.innerHTML += `<li>${step6}</li>`;
...
function makeBrusselsSprouts() {
  ...
  const promiseArray = [step0, step1, step2, step3, step4, step5, step6, step7];
  ...
  Promise.all(promiseArray)
    .then(([step0, step1, step2, step3, step4, step5, step6, step7]) => {
      ...
      brusselsSproutsElement.innerHTML += `<li>${step0}</li>`;
      brusselsSproutsElement.innerHTML += `<li>${step1}</li>`;
      brusselsSproutsElement.innerHTML += `<li>${step2}</li>`;
      brusselsSproutsElement.innerHTML += `<li>${step3}</li>`;
      brusselsSproutsElement.innerHTML += `<li>${step4}</li>`;
      brusselsSproutsElement.innerHTML += `<li>${step5}</li>`;
      brusselsSproutsElement.innerHTML += `<li>${step6}</li>`;
      brusselsSproutsElement.innerHTML += `<li>${step7}</li>`;
